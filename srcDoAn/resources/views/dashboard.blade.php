...
<head>
    ...
    <style>
        body {
            background-color: #1a1a1a; /* Đen */
            color: #333;
        }
        .sidebar {
            background-color: #2d2d2d; /* Đen pastel */
            min-height: 100vh;
            color: #f5f5f5; /* Trắng nhẹ cho chữ */
        }
        .sidebar h4 {
        ...
        .sidebar a {
            color: #f5f5f5; /* Trắng nhẹ cho liên kết */
            text-decoration: none;
            font-size: 1.2rem; /* Chữ to hơn */
            padding: 12px 0; /* Giãn cách trong */
            display: block; /* Đảm bảo liên kết chiếm toàn bộ chiều rộng */
            transition: color 0.3s ease; /* Hiệu ứng mượt khi hover */
        }
        .sidebar a:hover {
            color: #ff85c0; /* Hồng pastel đậm hơn khi hover */
        }
        .sidebar .nav-item {
            margin-bottom: 10px; /* Giãn cách giữa các mục */
        }
        .content {
            padding: 20px;
